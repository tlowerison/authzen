...
pub fn derive_enum(item: TokenStream) -> Result<TokenStream, Error> {
    ...
    let mod_name = format_ident!(
        "authzen_data_sources_diesel_enum_{}",
    ...
    let tokens = quote! {
        ...
        #vis mod #mod_name {
            use super::*;
            use ::authzen::data_sources::proc_macros_core::diesel::reexports::diesel::backend::{Backend, RawValue};
            use ::authzen::data_sources::proc_macros_core::diesel::reexports::diesel::deserialize::{self, FromSql};
            use ::authzen::data_sources::proc_macros_core::diesel::reexports::diesel::serialize::{self, Output, ToSql};
            use ::authzen::data_sources::proc_macros_core::diesel::reexports::diesel::sql_types;
            use ::authzen::data_sources::proc_macros_core::diesel::reexports::Enum;
            use ::authzen::data_sources::proc_macros_core::diesel::reexports::uuid as uuid;
            ...
            impl Enum for #ident {
                ...
                fn with_title(&self) -> ::authzen::data_sources::proc_macros_core::diesel::reexports::diesel::WithTitle<Self> {
                    ::authzen::data_sources::proc_macros_core::diesel::reexports::diesel::WithTitle {
                        id: self.into(),
                        title: self.clone(),
                    }
                }
