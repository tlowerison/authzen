use crate::diesel::util::{get_primary_key, DieselAttribute};
...
pub fn derive_audit(tokens: TokenStream) -> Result<TokenStream, Error> {
    ...
    let tokens = quote! {
        #[derive(Associations, Clone, ::authzen::data_sources::proc_macros_core::diesel::reexports::derivative::Derivative, Identifiable, Insertable, Queryable)]
        #[derivative(Debug)]
        #[diesel(
